...
king_slug = get_real_image(pygame.image.load('assets/enemies/king_slug.jpg'))

endings = [
    get_real_image(pygame.image.load('assets/endings/castle_on_fire.jpg')),
    get_real_image(pygame.image.load('assets/endings/death_of_king.jpg')),
    get_real_image(pygame.image.load('assets/endings/slugs_win.jpg'))
]
castle_on_fire = """Так пелось в манускриптах истории... Ничто не вечно под луной, ничто не вечно под монархической диктатурой. Все Ваши старания по сохранению и поддержанию условий жизни обычных горожан не увенчались успехом. К сожалению, Вам не удалось поддержать их уровень счастья с вечно растущими хотелками на должном уровне. Поэтому разъярённая толпа штурмом взяла Ваш замок. Случайно (но так ли это?) оброненный факел в стог сена начал нешуточный пожар, тушить который было некому. Вам ничего не оставалось, как в попытке сохранить свою жизнь, спрятаться в катакомбах под замком. Однако огонь обрушил хлипкую крышу замка, и, хотя Вас не нашли, Вы навеки погребены в подземелье с монстрами, которые уже, скаля клыки, стекаются в Вашу сторону. Плохая концовка.    """
death_of_king = """Об этой истории ходили легенды... Вам не только удалось удержать уровень счастья горожан, несмотря на их растущие аппетиты, но и получилось увеличить казну в 105 раз! Вы настолько прониклись симпатией к народу, что открыли ворота замка, пуская внутрь всех желающих. На балу перезнакомившись с тёмным лелеющим к Вам крестьянством, с ремесленниками и торговцами, с бедняками и богачами Вы на удивление толпы объявляете о своём уходе! Вы понимаете, что Ваша жизнь в замке имеет на порядок больший уровень, чем у всех присутствующих вместе, а это всё же очень несправедливо. Ваша большая симпатия к народу привела к краху монархии и установлении республики. За Вашу большую жертву Вам выделили маленькое поместье на окраине королевства, Вы провели остаток своих дней, находясь в блаженстве и счастье в полном отрыве от тягостных дел единоличного управления властью. Подземелье, из которого Вы доставали деньги, запечатали, так как оно представляло большую угрозу. Хорошая концовка.""" + ' ' * 23
my_friend_king_of_slugs = """'Удивительное дело - дружба с королём слизней!', - подумали Вы, приняв предложение побеждённого короля слизней. Вместе Вы покинули замок и королевство, унесясь вместе с другими слизняками, в закат. Секретная, и в общем-то хорошая, концовка.""" + ' ' * 10